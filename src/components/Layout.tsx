...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const tvCount = mockChannels.filter(c => c.type === 'tv').length;
  const radioCount = mockChannels.filter(c => c.type === 'radio').length;

  const navItems = [
    { id: 'home', label: 'Ana Sayfa', icon: Home, count: null },
    { id: 'tv', label: 'TV Kanalları', icon: Tv, count: tvCount },
    { id: 'radio', label: 'Radyolar', icon: RadioIcon, count: radioCount },
    { id: 'favorites', label: 'Favoriler', icon: Heart, count: favorites.length > 0 ? favorites.length : null, badgeColor: 'bg-red-500' },
    { id: 'history', label: 'Geçmiş', icon: History, count: history.length > 0 ? history.length : null },
    { id: 'm3u', label: 'M3U (Özel)', icon: List, count: customChannels.length > 0 ? customChannels.length : null },
  ...
  const mobileNavItems = [
    ...
    { id: 'radio', label: 'Radyo', icon: RadioIcon },
    { id: 'favorites', label: 'Favoriler', icon: Heart, count: favorites.length },
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-800 flex-shrink-0 space-y-2">
          <div className="flex items-center justify-between bg-gray-50 dark:bg-gray-800/60 p-2 rounded-xl border border-gray-200/80 dark:border-gray-700/60">
            ...
            <button
              ...
              title={themeMode === 'dark' ? 'Aydınlık Moda Geç' : 'Karanlık Moda Geç'}
            >
          ...
          >
            <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-700 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Klavye Kısayolları</h3>
              </div>
              <button 
                onClick={() => setShowShortcutsModal(false)}
            ...
            <div className="space-y-2.5 text-sm">
              <div className="flex items-center justify-between py-1.5 border-b border-gray-100 dark:border-gray-700/50">
                <span className="text-gray-600 dark:text-gray-300">Oynat / Duraklat</span>
              ...
              <div className="flex items-center justify-between py-1.5 border-b border-gray-100 dark:border-gray-700/50">
                <span className="text-gray-600 dark:text-gray-300">Tam Ekran Aç / Kapat</span>
              ...
              <div className="flex items-center justify-between py-1.5 border-b border-gray-100 dark:border-gray-700/50">
                <span className="text-gray-600 dark:text-gray-300">Sesi Kapat / Aç (Mute)</span>
              ...
              <div className="flex items-center justify-between py-1.5 border-b border-gray-100 dark:border-gray-700/50">
                <span className="text-gray-600 dark:text-gray-300">10 Saniye Geri / İleri (DVR)</span>
              ...
              <div className="flex items-center justify-between py-1.5 border-b border-gray-100 dark:border-gray-700/50">
                <span className="text-gray-600 dark:text-gray-300">Ses Artır / Azalt</span>
                <kbd className="px-2.5 py-1 bg-gray-100 dark:bg-gray-700 rounded-lg text-xs font-mono font-bold text-gray-800 dark:text-gray-200 border border-gray-200 dark:border-gray-600">↑ / ↓</kbd>
              </div>
              <div className="flex items-center justify-between py-1.5 border-b border-gray-100 dark:border-gray-700/50">
                <span className="text-gray-600 dark:text-gray-300">Önceki / Sonraki Kanal</span>
                <kbd className="px-2.5 py-1 bg-gray-100 dark:bg-gray-700 rounded-lg text-xs font-mono font-bold text-gray-800 dark:text-gray-200 border border-gray-200 dark:border-gray-600">[ / ]</kbd>
              </div>
              <div className="flex items-center justify-between py-1.5">
                <span className="text-gray-600 dark:text-gray-300">Hızlı Arama Çubuğu</span>
